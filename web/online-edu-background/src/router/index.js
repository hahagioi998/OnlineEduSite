...
export const constantRoutes = [
  ...
  // 首页
  {
    ...
    children: [{
      ...
      meta: { title: '谷粒学院后台首页', icon: 'nested' }
    }]
  },
  {
    path: 'external-link',
...
export const asyncRoutes = [
  //开发讲师管理模块
  {
    path: '/teacher',//一级路径
    component: Layout,
    redirect: '/teacher/table',//设定首页
    name: '讲师管理',
    meta: { title: '讲师管理', icon: 'example' },
    children: [
      {
        path: 'table',//二级路径，和一级路径组合形成前端内部的跳转路由
        name: '讲师列表',
        component: () => import('@/views/edu/teacher/list'),//设定跳转的vue界面
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'chart',
        name: '图表显示',
        component: () => import('@/views/edu/statistic/chart'),
