                  ...
                  <div class="cc-l-wrap">
                    ...
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
                        ...
                        <i class="c-fff fsize12 f-fA" v-if="course.price != 0">付费</i>
                      </span>
...
export default {
  ...
  methods: {
    ...
    showTeacherCourse(){
      index.getIndexInfo()
      .then((response) => {
        this.courseList = response.data.data.indexCourse
        this.teacherList = response.data.data.indexTeacher
      })
    }
  },
}
